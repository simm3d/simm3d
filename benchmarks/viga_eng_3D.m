...
%% TESTE DE MEMORIA
[user2, sys2] = memory; % de lugar no final do seu programa
memory_used_in_bytes = user1.MemAvailableAllArrays-user2.MemAvailableAllArrays;
memory_tol=round((memory_used_in_bytes/user1.MemAvailableAllArrays)*100);
Memory_used(ii)=memory_tol;
memo_usado=memory_used_in_bytes/1e09;
ii=ii+1;
